...
pygame.mixer.init()
fire_alert_sound = "audio"  # Replace with the path to your alert sound file
pygame.mixer.music.load(fire_alert_sound)

# Load the YOLO model
model = YOLO("path/to/your/trained_model/best.pt")  # Replace with the path to your trained model
